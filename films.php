...
<body>
	<div class="container-fluid bg-dark">
		...
		<div class="container col-md-6">
			<form method="post">
				<h2 class="text-uppercase text-center">STUDIO GHIBBLY FILMS</h2><br/>
                    <div style="text-align: center; solid">
                        <input type="button" name="submit" class="btn btn-primary" value="ALL GHIBBLI STUDIO FILMS" id="search-button">
                    </div>				
			</form>
		</div>
