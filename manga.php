...
<body>
	<div class="container-fluid bg-dark">
			...
			<div class="container">
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				    <ul class="navbar-nav mr-auto">
				        ...
				        <li class="nav-item">
				    	    <a class="nav-link" href="index.php">SEARCH ANIME</a>
					    </li>
                        <li class="nav-item">
		...
		<div class="container col-md-6">
			<form method="post">
				<h2 class="text-uppercase text-center">SEARCH MANGA</h2><br/>
		        <div class="form-group">
			 	    <label for="manga-title">Manga Title</label>
				    <input type="text" name="manga-title" placeholder="Manga Title..." class="form-control" id="search-input">
				</div>
	...
	<script src="script-manga.js"></script>
</body>
</html>